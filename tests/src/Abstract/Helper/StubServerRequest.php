...
class StubServerRequest implements ServerRequestInterface
{
    ...
    public function __construct(string $method = 'GET', string|UriInterface $uri = '/')
    {
        ...
        if (is_string($uri)) {
             $this->uri = new class($uri) implements UriInterface {
                 ...
                 public function withPath($path): UriInterface { $n = clone $this; $n->path = $path; return $n; }
    ...
    public function withUploadedFiles(array $uploadedFiles): ServerRequestInterface { $n = clone $this; $n->uploadedFiles = $uploadedFiles; return $n; }
    public function getParsedBody() { return $this->parsedBody; }
    public function withParsedBody($data): ServerRequestInterface { $n = clone $this; $n->parsedBody = (array)$data; return $n; }
    public function getAttributes(): array { return $this->attributes; }
    public function getAttribute($name, $default = null) { return $this->attributes[$name] ?? $default; }
    public function withAttribute($name, $value): ServerRequestInterface { $n = clone $this; $n->attributes[$name] = $value; return $n; }
    public function withoutAttribute($name): ServerRequestInterface { $n = clone $this; unset($n->attributes[$name]); return $n; }
    ...
    public function withMethod($method): ServerRequestInterface { $n = clone $this; $n->method = $method; return $n; }
    public function getUri(): UriInterface { return $this->uri; }
    public function withUri(UriInterface $uri, $preserveHost = false): ServerRequestInterface { $n = clone $this; $n->uri = $uri; return $n; }
}
